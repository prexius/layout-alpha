...
export function ThemeConfig() {
	...
	const [primaryColor, setPrimaryColor] = useState(config.colors?.defaultPrimaryColor || "teal")
	...
	useEffect(() => {
		const savedColor = localStorage.getItem("primaryColor") || config.colors?.defaultPrimaryColor || "teal"
